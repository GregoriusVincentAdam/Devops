...
<body>
    <div class="container">
        ...
        <form method="POST" action="http://103.176.78.186/unkpresent/public/home/inputstudent">
            ...
            <input type="submit" value="Sbmit" class="btn btn-primary mt-3">
        </form>
    </div>

    <!-- Tambahkan skript JavaScript Bootstrap -->
