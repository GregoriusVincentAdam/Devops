...
function plotDonut(indo, france, canada, usa, argen) {
  ...
  // Define Data
  var data = [{ labels: xArray, values, hole: 0.4, type: "pie" }];
...
document.getElementById("btn_update").onclick = function () {
  ...
  var val_indo = document.getElementById("id-fran").value;
  var val_indo = document.getElementById("id-cana").value;
  var val_indo = document.getElementById("id-usa").value;
  var val_indo = document.getElementById("id-arge").value;
